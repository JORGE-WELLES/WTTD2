...
class SubscribeTest(TestCase):
    ...
    def test_has_form_fields(self):
        ...
        form = self.resp.context["form"]
        self.assertSequenceEqual(['name', 'cpf', 'email', 'telefone'], list(form.fields))
...
class SubscribeSuccessMessage(TestCase):
    def test_massage(self):
        data = dict(name='Herique Bastos', cpf='12345678901', email='henrique@bastos.net',
